...
- (void)updateCellWithLock:(SLLock *)lock
{
    ...
    self.imageView.image = lock.isLocked.boolValue ? [UIImage imageNamed:@"lock-icon"] : nil;
    self.rightImageView.image = lock.isSharing.boolValue ? [UIImage imageNamed:@"sharebike-icon"] : nil;
}
